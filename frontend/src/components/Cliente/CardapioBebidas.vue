  ...
  <div class="container">
    ...
    <main class="main">
      ...
      <div class="tipo-pizza">
        <hr class="divider1">
        <button class="refrigerante" :class="{ 'active-button': activeButton === 'Refrigerante' }"
          @click="fetchMenuItems('Refrigerante')">
          <h2>Refrigerante</h2>
        </button>
        <button class="cerveja" :class="{ 'active-button': activeButton === 'Cerveja' }"
          @click="fetchMenuItems('Cerveja')">
          <h2>Cerveja</h2>
        </button>
        <button class="drinks" :class="{ 'active-button': activeButton === 'Drinks' }" @click="fetchMenuItems('Drinks')">
          <h2>Drinks</h2>
        </button>
        <button class="agua" :class="{ 'active-button': activeButton === 'Agua' }" @click="fetchMenuItems('Agua')">
          <h2>Água</h2>
        </button>
        <hr class="divider2">
      </div>
